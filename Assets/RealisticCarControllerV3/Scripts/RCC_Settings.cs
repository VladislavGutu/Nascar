...
public class RCC_Settings : ScriptableObject {
	...
	public enum ControllerType{Keyboard, Mobile, XBox360One, PS4, LogitechSteeringWheel, Nintendo, Custom}
	...
	// nINTENDO Inputs
	public string verticalInput_N = "Gas";
	public string horizontalInput_N = "Steer";
	public string mouseXInput_N = "Mouse X";
	public string mouseYInput_N = "Mouse Y";
	// public string handbrakeKB_N = KeyCode.Space;
	// public string startEngineKB_N = KeyCode.I;
	// public string lowBeamHeadlightsKB_N = KeyCode.L;
	// public string highBeamHeadlightsKB_N = KeyCode.K;
	// public string rightIndicatorKB_N = KeyCode.E;
	// public string leftIndicatorKB_N = KeyCode.Q;
	// public string hazardIndicatorKB_N = KeyCode.Z;
	// public string shiftGearUp_N = KeyCode.LeftShift;
	// public string shiftGearDown_N = KeyCode.LeftControl;
	// public string NGear_N = KeyCode.N;
	// public string boostKB_N = KeyCode.F;
	// public string slowMotionKB_N = KeyCode.G;
	// public string changeCameraKB_N = KeyCode.C;
	// public string recordKB_N = KeyCode.R;
	// public string playbackKB_N = KeyCode.P;
	// public string lookBackKB_N = KeyCode.B;
	// public string trailerAttachDetach_N = KeyCode.T;
