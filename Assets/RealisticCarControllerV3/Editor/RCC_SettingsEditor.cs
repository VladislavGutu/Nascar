...
public class RCC_SettingsEditor : Editor {
	...
	public override void OnInspectorGUI (){
		...
		if(foldControllerSettings){
			...
			controllerTypeStrings.Add("Keyboard");	controllerTypeStrings.Add("Mobile");	controllerTypeStrings.Add("XBox");	 controllerTypeStrings.Add("PS4");	 controllerTypeStrings.Add("Logitech Steering Wheel"); controllerTypeStrings.Add("Nintendo"); controllerTypeStrings.Add("Custom");
			EditorGUILayout.BeginVertical (GUI.skin.box);
...
//				EditorGUILayout.PropertyField(serializedObject.FindProperty("Xbox_playbackKB"), new GUIContent("Playback"));
			...
			if (RCCSettingsAsset.controllerSelectedIndex == 5)
			{
				...
				RCCSettingsAsset.controllerType = RCC_Settings.ControllerType.Nintendo;

				GUILayout.Label("Nintendo & One Settings", EditorStyles.boldLabel);

				GUI.color = new Color(.75f, 1f, .75f);
				EditorGUILayout.HelpBox("In this mode, inputs will be received from Nintendo & One controllers.", MessageType.Info);
				GUI.color = originalGUIColor;

				EditorGUILayout.PropertyField(serializedObject.FindProperty("verticalInput_N"), new GUIContent("Gas/Reverse Input Axis"));
				EditorGUILayout.PropertyField(serializedObject.FindProperty("horizontalInput_N"), new GUIContent("Steering Input Axis"));
				//EditorGUILayout.PropertyField(serializedObject.FindProperty("N_triggerRightInput"), new GUIContent("Gas Input Axis"));
				//EditorGUILayout.PropertyField(serializedObject.FindProperty("N_triggerLeftInput"), new GUIContent("Brake/Reverse Input Axis"));
				//EditorGUILayout.PropertyField(serializedObject.FindProperty("N_horizontalInput"), new GUIContent("Steering Input Axis"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_mouseXInput"), new GUIContent("Mouse X Input Axis"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_mouseYInput"), new GUIContent("Mouse Y Input Axis"));
				//
				// GUI.color = new Color(.75f, 1f, .75f);
				// EditorGUILayout.HelpBox("You can edit your vertical and horizontal input axis in Edit --> Project Settings --> Input.", MessageType.Info);
				// GUI.color = originalGUIColor;
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_handbrakeKB"), new GUIContent("Handbrake"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_startEngineKB"), new GUIContent("Start / Stop Engine Key"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_BeamHeadlightsKB"), new GUIContent("Beam Headlights"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_lowBeamHeadlightsKB"), new GUIContent("Low Beam Headlights"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_highBeamHeadlightsKB"), new GUIContent("High Beam Headlights"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_changeCameraKB"), new GUIContent("Change Camera"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_indicatorKB"), new GUIContent("Indicator Axis"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_hazardIndicatorKB"), new GUIContent("Indicator Hazard"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_shiftGearUp"), new GUIContent("Gear Shift Up"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_shiftGearDown"), new GUIContent("Gear Shift Down"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_boostKB"), new GUIContent("Boost / NOS"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_lookBackKB"), new GUIContent("Look Back"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_playbackKB"), new GUIContent("Playback"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_trailerAttachDetach"), new GUIContent("Trailer Attach/Detach"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_changecar"), new GUIContent("Change Car"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_autopilot"), new GUIContent("Auto Pilot"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_pause"), new GUIContent("Pause"));
				// EditorGUILayout.PropertyField(serializedObject.FindProperty("N_mirrors"), new GUIContent("Mirrors"));
				// EditorGUILayout.Space();
				// GUI.color = originalGUIColor;
			...
			if(RCCSettingsAsset.controllerSelectedIndex == 6){
